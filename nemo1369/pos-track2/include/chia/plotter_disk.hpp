...
public:
    ...
    void create_plot_disk(const std::string& filename, uint8_t k, uint8_t *memo, uint32_t memo_len, uint8_t *id,
        ...
        timer p3;
        Phase3Results res = compress_tables(k, results, filename, plot_filename, id, memo, memo_len);
...
private:
    ...
    Phase3Results compress_tables(uint8_t k, std::vector<uint64_t> plot_table_begin_pointers,
